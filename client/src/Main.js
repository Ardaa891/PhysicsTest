...
const ground = BABYLON.MeshBuilder.CreateCylinder("ground", {height: 1, diameter: 45}, scene);
...
var buildScene = async function (scene) {
    ...
    room.state.players.onAdd(function (player, sessionId) {
        ...
        _player = new Vehicle(sessionId, scene, new BABYLON.Vector3(player.x, player.y, player.z), new BABYLON.Quaternion(1, 1, 1), room,engine);
        console.log(_player);
